...
var file_v1_status_model_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x42, 0x2a, 0x5a, 0x28, 0x65, 0x64, 0x75, 0x73, 0x65, 0x61,
	0x6c, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x73,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x2f, 0x61, 0x70, 0x69, 0x76, 0x31, 0x2e, 0x73, 0x74, 0x61, 0x74,
...
var file_v1_status_model_proto_goTypes = []interface{}{
...
func file_v1_status_model_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_v1_status_model_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1_status_model_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1_status_model_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1_status_model_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1_status_model_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1_status_model_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
