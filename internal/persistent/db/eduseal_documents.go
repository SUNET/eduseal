...
func (c *EduSealDocColl) Save(ctx context.Context, doc *model.Document) error {
...
func (c *EduSealDocColl) Get(ctx context.Context, transactionID string) (*model.Document, error) {
