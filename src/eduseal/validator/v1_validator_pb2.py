...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_VALIDATEREPLY']._serialized_end=268
  _globals['_VALIDATOR']._serialized_start=270
  _globals['_VALIDATOR']._serialized_end=355
